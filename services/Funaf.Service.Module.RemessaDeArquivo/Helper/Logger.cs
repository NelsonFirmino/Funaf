...
namespace RemessaBB.FUNAF.Helper
{
    ...
    public static class Logger
    {
        ...
        /// <param name="source">The name of the app/process calling the logging method. If not provided,
        /// an attempt will be made to get the name of the calling process.</param>
        public static void LogException(Exception ex, string method = "", string source = "")
        {
            ...
            var m = (method.Length > 0) ? method.ToUpper() + " | " : "";
        ...
        //[SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "JvrisDetect.Utils.Logger.Log(System.String,System.Diagnostics.EventLogEntryType,System.String)")]
