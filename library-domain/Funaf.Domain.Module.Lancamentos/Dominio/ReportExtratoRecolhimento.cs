...
{
    [DBMappedClass(Table = "ReportExtratoArrecadacao", PrimaryKey = "idDados")]
    public class ReportExtratoRecolhimento
    {
        ...
        public static string CriarPDF(List<ReportExtratoRecolhimento> dados, string subTitulo)
        {
