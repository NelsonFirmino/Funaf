...
{
    [DBMappedClass(Table = "ReportDeclaradoRecolhimentoTotal", PrimaryKey = "idDados")]
    public class ReportDeclaradoRecolhimentoTotal
    {
        ...
        public static string CriarPDF(List<ReportDeclaradoRecolhimentoTotal> dados, string subTitulo)
        {
            ...
            PdfPTable tabela = new PdfPTable(3) { WidthPercentage = 70 };
            tabela.SpacingBefore = 20;
            tabela.SpacingAfter = 20;
            tabela.SetTotalWidth(new float[] { 20,20,20 });
